...
pro qball_nirc2, root_dir=root_dir, data_dir=data_dir, flats_dir=flats_dir, skyfiles=skyfiles, $
                src_names=src_names, extn=extn, headtxt_output=headtxt_output                  
...
if exists then root_dir=!ROOT_DIR
 ...
 for job=0,n_queuejobs-1 do begin
   ...
   if(manual eq 1) then begin     ; DO NOT do analysis ... just print out commands
       ...
       print,'frames=',frames,format='(a,"[",100(I4,","),"]")'
       print,'tsize=',tsize,format='(a,"[",100(f5.2,","))'
       print,'extn=',extn
       ...
       endelse
       print,'calc_bispect, cubeinfo',jobname,'.idlvar , root_dir'
       print,'calibrate_v2_cp, cubeinfo',jobname,'.idlvar , root_dir'
