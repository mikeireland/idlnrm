...
;    /quadsub:		Subtract lowered median off each quadrant.
...
pro raw2cube_nirc2,speck,ssky,datadir=datadir,  		$
	...
	noskyfit=noskyfit,setsquare=setsquare,plotall=plotall, quadsub
...
; %%%% Subtract quadrant offsets
  if (keyword_set(quadsub)) then begin
  	stop
  endif
