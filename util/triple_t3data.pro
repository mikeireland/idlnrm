...
function triple_t3data,binary_params,t3data=t3data,file=file
...
;   params(7) = PA or primary--> tertiary
;   params(8) =  UD size of tertiary
;   params(9) = brightness ratio of primary over tertiary
;;Note, 
...
triple_disks,t3data.u1,t3data.v1,binary_params,visib1,phases1
triple_disks,t3data.u2,t3data.v2,binary_params,visib2,phases2
triple_disks,t3data.u3,t3data.v3,binary_params,visib3,phases3
